...
const pages = [<Link to="/Rides">Rides</Link>, <Link to="/Spots">Trip Spots</Link>, 'Sejour'];
...
function ResponsiveAppBar() {
  ...
  const settings = [<Link to="/Profile">Profile</Link>, 'Account', 'Dashboard', < p onClick={() => logout()}>Logout</p>];
  return (
    <>
